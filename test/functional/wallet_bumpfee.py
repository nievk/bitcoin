...
def test_setfeerate(self, rbf_node, dest_address):
    ...
    test_response(requested=Decimal("1.999"), error=True, msg="The requested fee rate of 1.999 sat/vB cannot be less than the wallet min fee rate of 2.000 sat/vB. The current setting of 0.000 sat/vB for this wallet remains unchanged.")

    # Test setfeerate with valid values returns expected results
    rbfid = spend_one_input(rbf_node, dest_address)
    fee_rate_sat_vb = 25
    test_response(requested=fee_rate_sat_vb, expected=Decimal("25.000"), msg="Fee rate for transactions with this wallet successfully set to 25.000 sat/vB")
    bumped_tx = rbf_node.bumpfee(rbfid)
    ...
    test_response(requested=2.501, error=True, msg="The requested fee rate of 2.501 sat/vB cannot be greater than the wallet max fee rate of 2.500 sat/vB. The current setting of 0.000 sat/vB for this wallet remains unchanged.")
